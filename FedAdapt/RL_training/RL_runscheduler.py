...
def scope2():
    ...
    variable_name_list = ['max_episodes',
                   ...
                   'learning_rate',
                   'max_update_epochs'] 
    variables_list = [[1, 2, 205, 19794, 3, 55], [1, 2, 195, 19816, 29, 4], [1, 2, 192, 19783, 32, 14], [1, 2, 189, 19777, 31, 1], [1, 2, 185, 21707, 3, 14], [1, 2, 182, 23226, 3, 100], [1, 2, 100, 22605, 3, 66], [1, 2, 99, 22953, 28, 98], [1, 2, 107, 23236, 6, 5], [10, 2, 111, 22355, 29, 1], [30, 2, 114, 19771, 27, 16], [1, 2, 120, 19795, 3, 9], [1, 2, 123, 22349, 31, 5], [1, 2, 129, 22612, 9, 4], [1, 2, 133, 23285, 28, 87], [1, 2, 139, 22428, 29, 80], [1, 2, 153, 22935, 17, 5], [1, 2, 30, 23158, 6, 66], [1, 2, 21, 19761, 7, 3],[1, 2, 204, 25383, 11, 1], [1, 2, 194, 23379, 13, 57], [30, 2, 191, 20290, 5, 48], [1, 2, 186, 20542, 1, 3], [1, 2, 232, 25403, 6, 13], [77, 2, 100, 20352, 6, 5], [1, 2, 103, 22593, 109, 3], [1, 2, 105, 21294, 9, 14], [1, 2, 110, 22602, 17, 44], [1, 2, 114, 25403, 11, 5], [1, 2, 118, 22600, 154, 2], [1, 2, 167, 20058, 22, 1], [1, 2, 129, 22599, 59, 1], [1, 2, 273, 23415, 129, 7], [1, 2, 138, 18587, 1, 46], [1, 2, 155, 20069, 8, 14], [1, 2, 152, 20470, 13, 49], [1, 2, 30, 22559, 10, 3], [30, 2, 23, 25380, 8, 3]]
